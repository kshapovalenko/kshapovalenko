...
| Name         | Tech                  | Link         |
|--------------|-----------------------|--------------|
| [2024] **Decoding EEG Speech Perception with Transformers and VAE-based Data Augmentation** (Role - Technical Advisor) | EEG and EMG brain signal processing, CNN, Transformers, VAE | [ArXiv paper](https://arxiv.org/abs/2501.04359) and [GitHub](https://github.com/YHTerrance/silent_speech) | 
| [2024] **Improving SSVEP BCI Spellers with Data Augmentation and Language Models** (Role - Technical Advisor) | EEG brain signal processing, data augmentations, EEGNet, language modeling, RNN | [ArXiv paper](https://arxiv.org/abs/2412.20052) and [GitHub](https://github.com/kkipngenokoech/Hybrid-EEGNET-CharRNN-predictor) | 
