...
| Name         | Tech                  | Link         |
|--------------|-----------------------|--------------|
| [2024] **Improving SSVEP BCI Spellers with Data Augmentation and Language Models** - *Accepted to IEEE DSP 2025* | EEG brain signal processing, data augmentations, EEGNet, language modeling, RNN | [ArXiv paper](https://arxiv.org/abs/2412.20052) · [GitHub](https://github.com/kkipngenokoech/Hybrid-EEGNET-CharRNN-predictor) | 
| [2024] **Decoding EEG Speech Perception with Transformers and VAE-based Data Augmentation** | EEG and EMG brain signal processing, CNN, Transformers, VAE | [ArXiv paper](https://arxiv.org/abs/2501.04359) · [GitHub](https://github.com/YHTerrance/silent_speech) | 
