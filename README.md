...
| [2025] **Post-Training and Large-Scale Evals of Brain Foundation Models**  | Python, PyTorch, AWS, MLFlow, neural decoding (Stentrode™ endovascular BCI data), post-training and eval pipelines, cursor and command control | @ Synchron |
...
| [2024] **Aligning Brain Signals with Multimodal Speech and Vision Embeddings** | EEG brain signal and audio data pre-processing, Wav2Vec and CLIP model embeddings, ridge regression, contrastive decoding | [ArXiv](https://arxiv.org/abs/2511.00065) | 
...
| [2023-2024] **A Penny for Your Thoughts: Decoding Speech from Inexpensive Brain Signals** | EEG brain signal pre-processing, transformer-based models training, Python, PyTorch | [ArXiv](https://arxiv.org/abs/2511.04691) · [GitHub](https://github.com/kshapovalenko/DL-EEG-Speech-Decoder) |
